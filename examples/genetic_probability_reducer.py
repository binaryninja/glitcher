...
class GeneticProbabilityReducer:
    ...
    def __init__(self, model_name: str, base_text: str, target_token: str = None):
        """
    ...
    def save_results(self, population: List[Individual], output_file: str):
        ...
        results = {
            ...
            "target_token_text": self.tokenizer.decode([self.target_token_id]),
        ...
        for individual in population:
            if individual.fitness > 0:
                ...
                results["results"].append({
                    ...
                    "reduction_percentage": (individual.fitness / self.baseline_probability) * 100
                })
